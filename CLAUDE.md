...
**SmAs-AI** — a Chrome extension (Manifest v3, plain JS/HTML/CSS, no build step) that lets users chat with any webpage using AI. The extension scrapes and chunks page text, sends it to a Flask backend on AWS EC2, which does semantic search + LLM inference and returns an answer.
